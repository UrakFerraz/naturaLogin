...
<head>
	...
	<style>
		<?php require("style_1026.php"); ?>
		<?php require("style_natura.php"); ?>
	</style>
...
<div class="formContainer flex">
	<div class="form flex shadow-6">
		...
		<div class="btnEnviar flex">
			<button data-input>Enviar</button>
		</div>
	</div>
</div>
...

{
	...
	function randomi() {
		if(dataSec >= 0 && dataSec < 5) {
			imagemTag.style.background = `url("img/Layer-1slide.jpg")`;
		} else if(dataSec >= 5  && dataSec < 9) {
			imagemTag.style.background = `url("img/Layer-2slide.jpg")`;
		} else if(dataSec >= 9  && dataSec < 14) {
			imagemTag.style.background = `url("img/Layer-3slide.jpg")`;
		} else if(dataSec >= 14  && dataSec < 19) {
			imagemTag.style.background = `url("img/Layer-4slide.jpg")`;
		} else if(dataSec >= 19  && dataSec < 24) {
			imagemTag.style.background = `url("img/Layer-5slide.jpg")`;
		} else if(dataSec >= 24  && dataSec < 29) {
			imagemTag.style.background = `url("img/Layer-6slide.jpg")`;
		} else if(dataSec >= 29  && dataSec < 34) {
			imagemTag.style.background = `url("img/Layer-7slide.jpg")`;
		} else if(dataSec >= 34  && dataSec < 39) {
			imagemTag.style.background = `url("img/Layer-8slide.jpg")`;
		} else if(dataSec >= 39  && dataSec < 44) {
			imagemTag.style.background = `url("img/Layer-9slide.jpg")`;
		} else if(dataSec >= 44  && dataSec < 49) {
			imagemTag.style.background = `url("img/Layer-10slide.jpg")`;
		} else if(dataSec >= 49  && dataSec < 52) {
			imagemTag.style.background = `url("img/Layer-5slide.jpg")`;
		} else if(dataSec >= 52  && dataSec < 55) {
			imagemTag.style.background = `url("img/Layer-12slide.jpg")`;
		} else if(dataSec >= 54  && dataSec < 60) {
			imagemTag.style.background = `url("img/Layer-13slide.jpg")`;
		} else {
			imagemTag.style.background = `url("img/Layer-6slide.jpg")`;
		}
	}
